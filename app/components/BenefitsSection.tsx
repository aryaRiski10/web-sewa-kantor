export default function BenefitsSection() {
    return (
        <>
            <section id="Benefits" className="flex items-center justify-center w-[1024px] max-w-full mx-auto gap-[100px] max-lg:gap-[50px] mt-[100px] md:flex-row flex-col px-6">
                <h2 className="font-bold text-[32px] leading-[48px] text-nowrap max-md:text-2xl/normal">We Might Good <br />For Your Business</h2>
